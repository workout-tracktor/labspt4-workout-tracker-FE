...
export default function Button(props) {
    return (
        <StyledButton data-testid="option-button" data-txt={props.text} onClick={e => props.setGoal(e)} background={props.background} color={props.color} padding={props.padding}>
            {props.text}
        </StyledButton>
    )
};
