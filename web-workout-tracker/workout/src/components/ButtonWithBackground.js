...
export default function ButtonWithBackground(props) {
    return (
        <>
            ...
            {/* Desktop/tablet */}
            <Button data-testid="body-goal" type="desktop" url={props.url} onClick={props.onClick} onBlur={props.onBlur} opacity={props.opacity} gradient={props.gradient} onTouchStart={() => {}}>
                <img alt="" src={props.icon} style={{position: "absolute", left: "12px", top: "12px", width: "19px", height: "18px" }} />
                <Text>{props.text}</Text>
            </Button>

            {/* Mobile only */}
            <Button data-testid="body-goal" type="mobile" url={props.urlMobile} onClick={props.onClick} onBlur={props.onBlur} opacity={props.opacity} gradient={props.gradient} onTouchStart={() => {}}>
                <img alt="" src={props.icon} style={{position: "absolute", left: "12px", top: "12px", width: "19px", height: "18px" }} />
                <Text>{props.text}</Text>
            </Button>
        </>
